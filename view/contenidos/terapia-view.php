        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-55">
                        <h3>Nuestro Servicios en Terapia Física</h3>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<?php echo SERVERURL ?>view/img/department/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<?php echo SERVERURL ?>view/img/department/2.png" alt="">
                        </div>
                        <div class="department_content">
